      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mt-4 mt-lg-0 mt-md-0">
            <div
              class="bg-dark p-5 text-center d-flex flex-column h-100 rounded-custom aos-init aos-animate"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              <div class="promo-card-info mb-4">
                <h3 class="display-5 fw-bold mb-4">
                  <i class="fas fa-fingerprint text-warning me-2"></i> 10x
                </h3>
                <p>
          ...
          <div class="col-md-6 col-lg-4 mt-4 mt-lg-0 mt-md-0">
            ...
            >
              <div class="promo-card-info mb-4">
                <h3 class="display-5 fw-bold mb-4">
                  <i class="fas fa-paper-plane text-warning me-2"></i> 5k
                </h3>
                <p>
