    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                ...
                {data?.service_data?.map((item,idx)=>(       <div class="feature-card border border-light border-2 rounded-custom p-5">
                        ...
                        <Link to={item?.link_url} class="link-with-icon text-decoration-none mt-4">{item?.link_text} <i class="fas fa-arrow-right"></i></Link>
                    </div>
                ))}
                </div>
            </div>
