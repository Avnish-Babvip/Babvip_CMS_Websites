...
const Style10 = ({ data }) => {
  ...
  useEffect(() => {
    swiperRef.current = new Swiper(".aiart-post-slider", {
      modules: [Navigation, Autoplay], // Ensure module is included
      slidesPerView: 3,
      loop: true,
      speed: 800,
      spaceBetween: 24,
  ...
  return (
    <div class="aiart-post-area ptb-120 position-relative z-1">
      ...
      <div class="container">
        <div class="row align-items-end">
          ...
          <div class="col-xxl-6 col-lg-4">
            <div class="d-flex align-items-center justify-content-lg-end gap-4">
              <div
                class="aiart-slider-nav aiart-swiper-button-prev"
                tabindex="0"
                role="button"
                aria-label="Previous slide"
                aria-controls="swiper-wrapper-35ce6133c7226c3f"
              >
                <i class="fas fa-arrow-left"></i>
              </div>
              <div
                class="aiart-slider-nav aiart-swiper-button-next"
                tabindex="0"
                role="button"
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="aiart-post-slider mt-40 pb-20 swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
              <div
                class="swiper-wrapper"
                id="swiper-wrapper-930c5945b10d58f46"
                aria-live="off"
                style={{
              ...
              >
                {data?.step_data.map((item, index) => (
                  <div
                    ...
                    role="group"
                    style={{ width: "456px", "margin-right": "24px" }}
