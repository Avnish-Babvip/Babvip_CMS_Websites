...
<section class="feature-section pt-60 pb-120">
                ...
                <div class="row align-items-lg-center justify-content-between">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="pr-lg-4 position-relative aos-init aos-animate" data-aos="fade-up">
                            <ul class="position-absolute animate-element parallax-element shape-service z--1 hide-medium" style={ {
    position: 'absolute',
    display: 'block',
    left: '0px',
    top: '0px',
    ...
    backfaceVisibility: 'hidden',
                                ...
                                <li class="layer" data-depth="0.03" style={{
    position: 'absolute',
    display: 'block',
    left: '0px',
    top: '0px',
    ...
    backfaceVisibility: 'hidden',
                                ...
                                <li class="layer" data-depth="0.02" style={{
    position: 'absolute',
    display: 'block',
    left: '0px',
    top: '0px',
