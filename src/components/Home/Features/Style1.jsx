                ...
                <div class="container">
                    <div class="row align-content-center justify-content-center">
                        <div class="col-lg-6 col-md-12">
                            ...
                            {data?.step_data?.map((item,idx)=>(    <div key={idx} class="single-feature d-flex mb-4">
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="feature-shape-img position-relative mt-5 mt-lg-0">
                                ...
                                <img src={`${import.meta.env.VITE_REACT_APP_IMAGE_PATH}/${data?.image}`} alt={data?.image_alt_tag} class="img-fluid skewed-img-right rounded-custom shadow-lg" />
                            </div>
                        </div>
                    </div>
                </div>
