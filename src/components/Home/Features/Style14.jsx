            ...
            <div class="col-lg-7">
                <div class="p-cta-right position-relative mt-5 mt-lg-0">
                    ...
                    <ul class="payment-cta-shape list-unstyled">
                        <li>
                            <img src="assets/img/ps-1.png" class="shadow-md" alt="Shape"/>
                        </li>
                        <li><img src="assets/img/ps-2.png" alt="Shape"/></li>
                        <li>
                            <img src="assets/img/ps-3.png" class="shadow-lg rounded-circle" alt="Shape"/>
                        </li>
                        <li>
                            <img src="assets/img/ps-4.png" class="rouned-circle shadow-md" alt="Shape"/>
                        </li>
