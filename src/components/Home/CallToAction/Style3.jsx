                            ...
                            <div class="col-lg-5 col-md-10">
                                <div class="cta-with-feature-wrap p-5">
                                    ...
                                    <div class="form-block-banner mt-5">
                                        <form id="email-form" name="email-form" class="subscribe-form d-flex">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="img-with-shape-wrap">
                                    <div class="shape-top position-absolute top--40 z-2 right--40">
                                        <img src="assets/img/shape/circel-shape-top-1.png" alt="shape"/>
                                    </div>
                                    <div class="shape-image">
                                        <img src={`${import.meta.env.VITE_REACT_APP_IMAGE_PATH}/${data?.image}`} alt={data?.image_alt_tag} class="img-fluid screen-img"/>
                                    </div>

                                    <div class="shape-bottom">
                                        <img src="assets/img/shape/circel-shape-bottom-1.png" alt="shape"/>
                                        <img src="assets/img/shape/circel-shape-bottom-2.png" alt="shape"/>
                                    </div>
                                </div>
                            </div>
                        </div>
