                        ...
                        <div class="col-lg-6 col-md-12">
                           ...
                           <div  class="col-md-6">
                            {data?.steps?.slice(0, 2).map((item,idx)=>
                                 (<div key={idx} class="cta-card rounded-custom text-center shadow p-5 bg-white my-4">
                                ...
                                {data?.steps?.slice(2,3).map((item,idx)=>
                                    <div  key={idx} class="cta-card rounded-custom text-center shadow p-5 bg-white">
                                        <h3 class="display-5 fw-bold">{item?.step_title}</h3>
                                        <p class="mb-0">{item?.step_description}</p>
                                    </div>
                                  )}
