                        ...
                        <div class="col-lg-6 col-md-10">
                            <div class="hero-content-wrap mt-5">
                                ...
                                <div class="action-btn mt-5 align-items-center d-block d-sm-flex d-lg-flex d-md-flex">
                                    <Link to={data?.button_url} class="btn btn-danger me-3">{data?.button_text}</Link>
                                ...
                                <div class="row justify-content-lg-start mt-60">
                                  ...
                                  {  data?.top_client_image?.map((item,idx)=>(  <div key={idx} class="col-4 col-sm-3 my-2 ps-lg-0">
