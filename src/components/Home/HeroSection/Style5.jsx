...
const Style5 = ({data}) => {
  return (
    <section class="hero-section ptb-120 text-white bg-dark" style={{background: `url(${import.meta.env.VITE_REACT_APP_IMAGE_PATH}/${data?.banner_bg_image})no-repeat center right`}}>
    <div class="container">
        <div class="row justify-content-center text-center text-lg-start align-items-center">
            <div class="col-lg-6 col-md-10">
                <div class="hero-content-wrap mt-5 mt-lg-0 mt-xl-0">
                    ...
                    <p class="lead" data-aos="fade-up">{data?.banner_description}</p>
                    <div class="action-btns mt-5" data-aos="fade-up" data-aos-delay="50">
                        ...
                        <Link to={data?.button_url2} class="btn btn-outline-light">{data?.button_text2}</Link>
                    </div>
                    ...
                    {  data?.top_client_image?.map((item,idx)=>(    <img key={idx} src={`${import.meta.env.VITE_REACT_APP_IMAGE_PATH}/${item?.top_client_image}`} alt={item?.icon_alt_tag} class="me-4 img-fluid"/>))}
            ...
            <div class="col-lg-6 col-md-8">
                <div class="hero-img-wrap position-relative app-screen-bg mt-5"  data-aos="fade-up" data-aos-delay="200" style={{ "background-image": "url('assets/img/shape/shape-bg-3.svg')"}}>
