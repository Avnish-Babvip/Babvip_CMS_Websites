                ...
                <div class="row justify-content-center">
                    <div class="col-xl-7">
                        <div class="crm-title text-center">
                            <span class="crm-subtitle">{data?.title} <img src="assets/img/shape/arrow-red.png" alt="arrow" class="ms-1"/></span>
                            <h2 class="mt-2 mb-3 clr-text">{data?.sub_title}</h2>
                            <p class="mb-0">{data?.description} </p>
                            <Link to={data?.button_url} class="btn crm-primary-btn mt-40">{data?.button_text}</Link>
                        </div>
                    </div>
                </div>
            </div>
