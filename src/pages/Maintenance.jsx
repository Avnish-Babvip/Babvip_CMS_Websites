...
const Maintenance = () => {
  ...
  const onSubmit = (data) => {
    dispatch(addMaintenanceEnquiry(data));
    reset();
  };
  return (
    <>
      <section>
        <div class="navbar-brand d-flex align-items-center justify-content-center w-100 mt-2 mb-md-0 text-decoration-none">
      ...
      >
        <div class="bg-primary text-white mb-5">
          <marquee behavior="scroll" direction="left">
            We are currently undergoing maintenance. We'll be back soon! 🚀
          </marquee>
        </div>
        <div class="container">
